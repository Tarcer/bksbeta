...
export default function Home() {
  ...
  return (
    <div className="container p-5">
      ...
      <div>
      <table class="table table-striped text-dark m-5">
      ...
      <h5 className="text-dark text-center">Commencer votre expérience</h5>
